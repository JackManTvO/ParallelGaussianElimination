...
int main(int agrc, char *agrv[])
{
    ...
    printf("Starting sequential computation with blocking and loop unrolling...\n\n");

    /***sequential computation with blocking and loop unrolling***/
    gettimeofday(&start_time, 0);
    ...
    microseconds = end_time.tv_usec - start_time.tv_usec;
    elapsed = seconds + 1e-6 * microseconds;
    printf("sequential calculation with blocking and loop unrolling time: %f\n\n", elapsed);
